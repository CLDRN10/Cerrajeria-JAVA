...
/**
 * ==================================================================
 * PAQUETE vista_interfaz
 * ==================================================================
 * Este paquete contiene todas las clases relacionadas con la interfaz
 * gráfica de usuario (GUI). La "Vista" en el patrón Modelo-Vista-Controlador (MVC).
 * Su responsabilidad es mostrar los datos al usuario y capturar sus acciones (clics, etc.).
